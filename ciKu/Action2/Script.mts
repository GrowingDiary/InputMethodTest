'Log Parameter
Print("INFO " & Environment("ActionName") & " - Parameter Path: " & parameter("ExePath"))
...
'Configuring
Dialog("2345王牌输入法设置向导").WinComboBox("每页候选个数").Select "8" @@ hightlight id_;_592570_;_script infofile_;_ZIP::ssf53.xml_;_
Dialog("2345王牌输入法设置向导").WinComboBox("字体大小设置").Select "大" @@ hightlight id_;_789932_;_script infofile_;_ZIP::ssf54.xml_;_
